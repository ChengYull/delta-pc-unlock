...
> **顶栏标识 `assets/delta-mark.png` 是第三方商标素材。** 它是从《三角洲行动》的公开
> 游戏标识（Steam 资源里的 640×360 logo）裁出 emblem、补深色圆角底做成的 128×128 图。
> 如果本项目没有该标识的使用授权，请换回自绘版本——`git show 0a12b76:src/styles.css`
> 里有原来的三横条 `.brand__mark`（纯 CSS 画的琥珀色方块，无版权问题）。
> 平台《小程序工坊上架规则》第二条要求图片、商标/特定标识、游戏资源都必须有合法来源，
> 且在审核、巡查或收到投诉时有权要求开发者提供授权证明；第十二条明确禁止使用
> 第三方权益人的图标。**上架前请自行确认。**
